...
<div class="container">
	<div class="row">
		<div class="col-md-9 col-xs-12">
			<div class="row">
				<div class="col-md-12">
					<div class="well" style="height:380px;background-color:cyan;">
			...
			<div class="row">
				<div class="col-md-4 visible-lg">
					<div class="well" style="height:300px;background-color:yellow;">
						
					</div>
				</div>
				<div class="col-md-4 visible-lg">
					<div class="well" style="height:300px;background-color:green;">
		...
		<div class="col-md-3 col-xs-12">
			<div class="well" style="height:700px;background-color:red;">
